...
void Init_Graphics()
{
    ...
    if( SDL_VideoModeOK( 440, 480, 32, SDL_ANYFORMAT | SDL_HWSURFACE ) ) 
    {
        S_Data.xres = 440;
        S_Data.yres = 480;
        S_Data.depth = 32;
    ...
    else if( SDL_VideoModeOK( 440, 480, 16, SDL_ANYFORMAT | SDL_HWSURFACE ) )
    { 
        S_Data.xres = 440;
        S_Data.yres = 480;
        S_Data.depth = 16;
    ...
    else if( SDL_VideoModeOK( 440, 480, 16, SDL_ANYFORMAT ) )
    {
        S_Data.xres = 440;
        S_Data.yres = 480;
        S_Data.depth = 16;
